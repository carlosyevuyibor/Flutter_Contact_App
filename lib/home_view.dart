        ...
        actions: const [
          Padding(
            ...
            child: Center(
              child: CircleAvatar(
                radius: 25,
                backgroundImage: AssetImage('images/persons1.jpg'),
              ),
            ),
          )
        ],
            ...
            ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    onTap: () {
                      Navigator.push(context,
                        ...
                        return ContactDetailsView(
                            contact: Contact(
                                country: 'Ghana',
                                email: 'carlosyevu1@gmail.com',
                                name: 'carlos yevu',
                                phone: '+233 551 3255 19',
                    ...
                    subtitle: const Text('+233 55 132 55 19'),
                ...
                return Column(
                  children: [
                    ListTile(
                      ...
                      leading: const CircleAvatar(
                        radius: 25,
                        backgroundImage: AssetImage('images/persons3.jpg'),
                      ),
                      title: Text(
                        '${element['name']}',
                        style: const TextStyle(
